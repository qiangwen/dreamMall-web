 ...
 * 
 */
package com.mall.web.connection;
...
public class HttpConnectionClient {
	...
	public String getContextByGetMethod(String url) {
		...
		try {
			...
			throw new RuntimeException("HttpClient catch!", e);
		} finally {
	...
	public String getContextByPostMethod(String url, List<KeyValue> params) {
		...
		try {
			...
			for (KeyValue kv : params) {
				nvps[i] = new NameValuePair(kv.getKey().toString(), kv.getValue().toString());
				i++;
			}
	...
	public String getContextByMethod(String url, String method,
		...
		try {
			...
			if ("POST".equalsIgnoreCase(method)) {
				...
				throw new RuntimeException("Nonsupport this method: " + method);
			}
			addReuestHeader(mt);
